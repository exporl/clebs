...
clebsDependency(protobuf) {
    ...
    protobuf_decl.commands = $$PROTOBUFPROTOC --cpp_out=$$OBJECTS_DIR $$PROTOPATHS ${QMAKE_FILE_NAME}
    ...
    protobuf_python.commands = $$PROTOBUFPROTOC --python_out=$$DESTDIR $$PROTOPATHS ${QMAKE_FILE_NAME}
